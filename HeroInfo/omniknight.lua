...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, Purification:GetName())
	table.insert(abilities, HeavenlyGrace:GetName())
	table.insert(abilities, HammerOfPurity:GetName())
	table.insert(abilities, GuardianAngel:GetName())
...
function X.GetHeroItemBuild()
	...
	if PRoles.GetPRole(bot, bot:GetUnitName()) == "HardSupport" or PRoles.GetPRole(bot, bot:GetUnitName()) == "SoftSupport" then
		ItemBuild = { 
		--"item_null_talisman",
		-- "item_magic_wand",
		-- "item_arcane_boots",
